        ...
        <div class="swiper mySwiper">
          ...
          <div class="swiper-nav">
            ...
            <svg width="26" height="15" viewBox="0 0 26 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M0.999999 14L12.6364 2L25 14" stroke="white" stroke-width="2"></path>
              </svg>
            </div>
            <div class="swiper-pagination"></div>
            <div class="swiper-button-next">
            <svg width="26" height="15" viewBox="0 0 26 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M25 1L13.3636 13L0.999999 1" stroke="white" stroke-width="2"></path>
              </svg>
            </div>
          </div>
        ...
        <ul class="news__list card-list list-reset">
          <li class="news__item">
            <a href="#">
              ...
              <h3 class="news__title">Пример заголовка новости он может быть длинным и идти в несколько строк</h3>
            </a>
          </li>
          <li class="news__item">
            <a href="#">
      ...
      <div class="wrapper">
        ...
        <div class="about__grid">
          ...
          <div class="about__details">
            <p class="lead">Значительную часть своего свободного времени граждане проводят во дворах и общественных
