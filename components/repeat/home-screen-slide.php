...
<div class="swiper-slide">
  <!-- содержимое слайда  -->
  <div class="home-screen__slide">
    <!-- иконка -->
    <div class="home-screen__image">
      <img src="./img/home-slider/1_animated.svg" alt="Иконка слайда" width="400" data-swiper-parallax="-800">
    </div>
    <!-- правая часть  -->
    <div class="home-screen__details">
      ...
      <div class="tags-with-label">
        <ul class="tag-list list-reset">
          ...
          <li data-swiper-parallax="-650"><a href="#"
              class="tag-list__link"><span>Образование</span></a></li>
        </ul>
        <p class="tags-with-label__text" data-swiper-parallax="-550">24 апреля, 2022 <b>до 24 августа, 2023</b></p>
      </div>
      <!-- заголовок  -->
